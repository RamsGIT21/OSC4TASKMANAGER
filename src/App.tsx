    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-400 via-blue-300 to-cyan-200 flex items-center justify-center px-4">
      <div className="text-center max-w-4xl w-full space-y-12">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-16">
          <button className="w-full sm:w-64 bg-white text-blue-600 font-semibold text-xl py-5 px-10 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:bg-blue-50">
            Login
          </button>
